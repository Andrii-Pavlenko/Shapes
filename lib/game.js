...
var Shapes = /** @class */ (function () {
    function Shapes() {
        ...
        this.createTriangle = function (triangle) {
            var firstValue = Math.floor(Math.random() * 50) + 10;
            var secondValue = Math.floor(Math.random() * 50) + firstValue;
            var coordinates = [
                firstValue,
                firstValue,
                firstValue,
        ...
        this.createPentagon = function (pentagon) {
            var firstValue = Math.floor(Math.random() * 50);
            var thirdValue = Math.floor(Math.random() * 50) + firstValue;
            var fourthValue = Math.floor(Math.random() * 50) + thirdValue;
            var coordinates = [
                firstValue,
                firstValue,
                thirdValue,
        ...
        this.createHexagon = function (hexagon) {
            var firstValue = Math.floor(Math.random() * 50);
            var secondValue = Math.floor(Math.random() * 50) + firstValue;
            var thirdValue = Math.floor(Math.random() * 50) + secondValue;
            var coordinates = [
                firstValue,
                firstValue,
                secondValue,
    ...
    Shapes.prototype.createRectangle = function (rect) {
        rect.drawRect(0, 0, Math.floor(Math.random() * 50) + 30, Math.floor(Math.random() * 50) + 30);
